...
// makeOperationContainerContainerArchiveCmd returns a command to handle operation containerArchive
...
func parseOperationContainerContainerArchiveResult(resp0 *container.ContainerArchiveOK, respErr error) (string, error) {
	if respErr != nil {
		...
		eresp1, ok := iResp1.(*container.ContainerArchiveBadRequest)
		if ok {
		...
		eresp2, ok := iResp2.(*container.ContainerArchiveNotFound)
		if ok {
			// the error response has a payload
		...
		eresp3, ok := iResp3.(*container.ContainerArchiveInternalServerError)
		if ok {
			// the error response has a payload
...
func registerModelContainerArchiveBadRequestBodyFlags(depth int, cmdPrefix string, cmd *cobra.Command) error {
	...
	if err := registerContainerArchiveBadRequestBodyPropAnonContainerArchiveBadRequestBodyAO1Message(depth, cmdPrefix, cmd); err != nil {
		return err
	}
...
func registerContainerArchiveBadRequestBodyPropAnonContainerArchiveBadRequestBodyAO1Message(depth int, cmdPrefix string, cmd *cobra.Command) error {
	if depth > maxDepth {
		return nil
	}
...
func retrieveModelContainerArchiveBadRequestBodyFlags(depth int, m *container.ContainerArchiveBadRequestBody, cmdPrefix string, cmd *cobra.Command) (error, bool) {
	...
	err, MessageAdded := retrieveContainerArchiveBadRequestBodyPropAnonContainerArchiveBadRequestBodyAO1MessageFlags(depth, m, cmdPrefix, cmd)
	if err != nil {
		return err, false
	}
...
func retrieveContainerArchiveBadRequestBodyPropAnonContainerArchiveBadRequestBodyAO1MessageFlags(depth int, m *container.ContainerArchiveBadRequestBody, cmdPrefix string, cmd *cobra.Command) (error, bool) {
	if depth > maxDepth {
		return nil, false
	}
	retAdded := false
