## dockerctl container ContainerTop

On Unix systems, this is done by running the `ps` command. This endpoint is not supported on Windows.

```
dockerctl container ContainerTop [flags]
```

### Options

```
  -h, --help         help for ContainerTop
      --id string    Required. ID or name of the container
      --ps_args ps   The arguments to pass to ps. For example, `aux` (default "-ef")
```
