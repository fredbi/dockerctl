...
func (o *SecretCreateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 503:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[POST /secrets/create] SecretCreate", response, response.Code())
	}
}
...
// Code gets the status code for the secret create created response
func (o *SecretCreateCreated) Code() int {
	return 201
}

func (o *SecretCreateCreated) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /secrets/create][%d] secretCreateCreated %s", 201, payload)
}
...
// Code gets the status code for the secret create conflict response
func (o *SecretCreateConflict) Code() int {
	return 409
}

func (o *SecretCreateConflict) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /secrets/create][%d] secretCreateConflict %s", 409, payload)
}
...
// Code gets the status code for the secret create internal server error response
func (o *SecretCreateInternalServerError) Code() int {
	return 500
}

func (o *SecretCreateInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /secrets/create][%d] secretCreateInternalServerError %s", 500, payload)
}
...
// Code gets the status code for the secret create service unavailable response
func (o *SecretCreateServiceUnavailable) Code() int {
	return 503
}

func (o *SecretCreateServiceUnavailable) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /secrets/create][%d] secretCreateServiceUnavailable %s", 503, payload)
}

func (o *SecretCreateServiceUnavailable) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /secrets/create][%d] secretCreateServiceUnavailable %s", 503, payload)
}
...
*/
type SecretCreateParamsBodyAllOf1 any
