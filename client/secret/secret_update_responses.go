...
func (o *SecretUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 503:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[POST /secrets/{id}/update] SecretUpdate", response, response.Code())
	}
}
...
// Code gets the status code for the secret update o k response
func (o *SecretUpdateOK) Code() int {
	return 200
}
...
// Code gets the status code for the secret update bad request response
func (o *SecretUpdateBadRequest) Code() int {
	return 400
}

func (o *SecretUpdateBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /secrets/{id}/update][%d] secretUpdateBadRequest %s", 400, payload)
}
...
// Code gets the status code for the secret update not found response
func (o *SecretUpdateNotFound) Code() int {
	return 404
}

func (o *SecretUpdateNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /secrets/{id}/update][%d] secretUpdateNotFound %s", 404, payload)
}
...
// Code gets the status code for the secret update internal server error response
func (o *SecretUpdateInternalServerError) Code() int {
	return 500
}

func (o *SecretUpdateInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /secrets/{id}/update][%d] secretUpdateInternalServerError %s", 500, payload)
}
...
// Code gets the status code for the secret update service unavailable response
func (o *SecretUpdateServiceUnavailable) Code() int {
	return 503
}

func (o *SecretUpdateServiceUnavailable) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /secrets/{id}/update][%d] secretUpdateServiceUnavailable %s", 503, payload)
}
