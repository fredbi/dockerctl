...
func (o *SecretDeleteReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 503:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[DELETE /secrets/{id}] SecretDelete", response, response.Code())
	}
}
...
func (o *SecretDeleteNotFound) Error() string {
	...
	return fmt.Sprintf("[DELETE /secrets/{id}][%d] secretDeleteNotFound %s", 404, payload)
}
...
func (o *SecretDeleteInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /secrets/{id}][%d] secretDeleteInternalServerError %s", 500, payload)
}
...
// Code gets the status code for the secret delete service unavailable response
func (o *SecretDeleteServiceUnavailable) Code() int {
	return 503
}

func (o *SecretDeleteServiceUnavailable) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /secrets/{id}][%d] secretDeleteServiceUnavailable %s", 503, payload)
}
