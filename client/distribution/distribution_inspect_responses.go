...
func (o *DistributionInspectReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 500:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[GET /distribution/{name}/json] DistributionInspect", response, response.Code())
	}
}
...
func (o *DistributionInspectOK) Error() string {
	...
	return fmt.Sprintf("[GET /distribution/{name}/json][%d] distributionInspectOK %s", 200, payload)
}
...
func (o *DistributionInspectUnauthorized) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /distribution/{name}/json][%d] distributionInspectUnauthorized %s", 401, payload)
}
...
func (o *DistributionInspectInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /distribution/{name}/json][%d] distributionInspectInternalServerError %s", 500, payload)
}
