...
func (o *VolumeListReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 500:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[GET /volumes] VolumeList", response, response.Code())
	}
}
...
// Code gets the status code for the volume list o k response
func (o *VolumeListOK) Code() int {
	return 200
}

func (o *VolumeListOK) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /volumes][%d] volumeListOK %s", 200, payload)
}
...
// Code gets the status code for the volume list internal server error response
func (o *VolumeListInternalServerError) Code() int {
	return 500
}

func (o *VolumeListInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /volumes][%d] volumeListInternalServerError %s", 500, payload)
}
