...
func (o *VolumePruneReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 500:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[POST /volumes/prune] VolumePrune", response, response.Code())
	}
}
...
// Code gets the status code for the volume prune o k response
func (o *VolumePruneOK) Code() int {
	return 200
}

func (o *VolumePruneOK) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /volumes/prune][%d] volumePruneOK %s", 200, payload)
}
...
// Code gets the status code for the volume prune internal server error response
func (o *VolumePruneInternalServerError) Code() int {
	return 500
}

func (o *VolumePruneInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /volumes/prune][%d] volumePruneInternalServerError %s", 500, payload)
}
