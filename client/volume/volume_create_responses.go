...
func (o *VolumeCreateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 500:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[POST /volumes/create] VolumeCreate", response, response.Code())
	}
}
...
func (o *VolumeCreateCreated) Error() string {
	...
	return fmt.Sprintf("[POST /volumes/create][%d] volumeCreateCreated %s", 201, payload)
}
...
// Code gets the status code for the volume create internal server error response
func (o *VolumeCreateInternalServerError) Code() int {
	return 500
}

func (o *VolumeCreateInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /volumes/create][%d] volumeCreateInternalServerError %s", 500, payload)
}
