...
func (o *TaskLogsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 503:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[GET /tasks/{id}/logs] TaskLogs", response, response.Code())
	}
}
...
// Code gets the status code for the task logs o k response
func (o *TaskLogsOK) Code() int {
	return 200
}

func (o *TaskLogsOK) Error() string {
	return fmt.Sprintf("[GET /tasks/{id}/logs][%d] taskLogsOK", 200)
}
...
// Code gets the status code for the task logs not found response
func (o *TaskLogsNotFound) Code() int {
	return 404
}

func (o *TaskLogsNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /tasks/{id}/logs][%d] taskLogsNotFound %s", 404, payload)
}
...
// Code gets the status code for the task logs internal server error response
func (o *TaskLogsInternalServerError) Code() int {
	return 500
}

func (o *TaskLogsInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /tasks/{id}/logs][%d] taskLogsInternalServerError %s", 500, payload)
}
...
// Code gets the status code for the task logs service unavailable response
func (o *TaskLogsServiceUnavailable) Code() int {
	return 503
}

func (o *TaskLogsServiceUnavailable) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /tasks/{id}/logs][%d] taskLogsServiceUnavailable %s", 503, payload)
}
