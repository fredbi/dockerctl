...
func (o *SystemEventsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 500:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[GET /events] SystemEvents", response, response.Code())
	}
}
...
// Code gets the status code for the system events o k response
func (o *SystemEventsOK) Code() int {
	return 200
}

func (o *SystemEventsOK) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /events][%d] systemEventsOK %s", 200, payload)
}
...
// Code gets the status code for the system events bad request response
func (o *SystemEventsBadRequest) Code() int {
	return 400
}

func (o *SystemEventsBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /events][%d] systemEventsBadRequest %s", 400, payload)
}
...
// Code gets the status code for the system events internal server error response
func (o *SystemEventsInternalServerError) Code() int {
	return 500
}

func (o *SystemEventsInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /events][%d] systemEventsInternalServerError %s", 500, payload)
}
