...
func (o *SystemVersionReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 500:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[GET /version] SystemVersion", response, response.Code())
	}
}
...
func (o *SystemVersionOK) Error() string {
	...
	return fmt.Sprintf("[GET /version][%d] systemVersionOK %s", 200, payload)
}
...
// Code gets the status code for the system version internal server error response
func (o *SystemVersionInternalServerError) Code() int {
	return 500
}

func (o *SystemVersionInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /version][%d] systemVersionInternalServerError %s", 500, payload)
}
...
func (o *ComponentVersion) validateVersion(formats strfmt.Registry) error {
	...
	if err := validate.RequiredString("Version", "body", o.Version); err != nil {
		return err
	}
...
func (o *SystemVersionOKBody) contextValidatePlatform(ctx context.Context, formats strfmt.Registry) error {
