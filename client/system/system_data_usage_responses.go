...
func (o *SystemDataUsageReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 500:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[GET /system/df] SystemDataUsage", response, response.Code())
	}
}
...
// Code gets the status code for the system data usage o k response
func (o *SystemDataUsageOK) Code() int {
	return 200
}

func (o *SystemDataUsageOK) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /system/df][%d] systemDataUsageOK %s", 200, payload)
}
...
// Code gets the status code for the system data usage internal server error response
func (o *SystemDataUsageInternalServerError) Code() int {
	return 500
}

func (o *SystemDataUsageInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /system/df][%d] systemDataUsageInternalServerError %s", 500, payload)
}
