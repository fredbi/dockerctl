...
func (o *SystemAuthReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 500:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[POST /auth] SystemAuth", response, response.Code())
	}
}
...
// Code gets the status code for the system auth o k response
func (o *SystemAuthOK) Code() int {
	return 200
}

func (o *SystemAuthOK) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /auth][%d] systemAuthOK %s", 200, payload)
}
...
// Code gets the status code for the system auth no content response
func (o *SystemAuthNoContent) Code() int {
	return 204
}
...
// Code gets the status code for the system auth internal server error response
func (o *SystemAuthInternalServerError) Code() int {
	return 500
}

func (o *SystemAuthInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /auth][%d] systemAuthInternalServerError %s", 500, payload)
}
