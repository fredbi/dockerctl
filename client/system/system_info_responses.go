...
func (o *SystemInfoReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 500:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[GET /info] SystemInfo", response, response.Code())
	}
}
...
func (o *SystemInfoOK) Error() string {
	...
	return fmt.Sprintf("[GET /info][%d] systemInfoOK %s", 200, payload)
}
...
func (o *SystemInfoInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /info][%d] systemInfoInternalServerError %s", 500, payload)
}
