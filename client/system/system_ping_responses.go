...
func (o *SystemPingReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 500:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[GET /_ping] SystemPing", response, response.Code())
	}
}
...
// Code gets the status code for the system ping o k response
func (o *SystemPingOK) Code() int {
	return 200
}

func (o *SystemPingOK) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /_ping][%d] systemPingOK %s", 200, payload)
}
...
// Code gets the status code for the system ping internal server error response
func (o *SystemPingInternalServerError) Code() int {
	return 500
}

func (o *SystemPingInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /_ping][%d] systemPingInternalServerError %s", 500, payload)
}
