...
func (o *ServiceCreateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 503:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[POST /services/create] ServiceCreate", response, response.Code())
	}
}
...
// Code gets the status code for the service create created response
func (o *ServiceCreateCreated) Code() int {
	return 201
}

func (o *ServiceCreateCreated) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /services/create][%d] serviceCreateCreated %s", 201, payload)
}
...
// Code gets the status code for the service create bad request response
func (o *ServiceCreateBadRequest) Code() int {
	return 400
}

func (o *ServiceCreateBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /services/create][%d] serviceCreateBadRequest %s", 400, payload)
}
...
// Code gets the status code for the service create forbidden response
func (o *ServiceCreateForbidden) Code() int {
	return 403
}

func (o *ServiceCreateForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /services/create][%d] serviceCreateForbidden %s", 403, payload)
}
...
// Code gets the status code for the service create conflict response
func (o *ServiceCreateConflict) Code() int {
	return 409
}

func (o *ServiceCreateConflict) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /services/create][%d] serviceCreateConflict %s", 409, payload)
}
...
// Code gets the status code for the service create internal server error response
func (o *ServiceCreateInternalServerError) Code() int {
	return 500
}

func (o *ServiceCreateInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /services/create][%d] serviceCreateInternalServerError %s", 500, payload)
}
...
// Code gets the status code for the service create service unavailable response
func (o *ServiceCreateServiceUnavailable) Code() int {
	return 503
}

func (o *ServiceCreateServiceUnavailable) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /services/create][%d] serviceCreateServiceUnavailable %s", 503, payload)
}
...
*/
type ServiceCreateParamsBodyAllOf1 any
