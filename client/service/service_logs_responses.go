...
func (o *ServiceLogsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 503:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[GET /services/{id}/logs] ServiceLogs", response, response.Code())
	}
}
...
// Code gets the status code for the service logs o k response
func (o *ServiceLogsOK) Code() int {
	return 200
}

func (o *ServiceLogsOK) Error() string {
	return fmt.Sprintf("[GET /services/{id}/logs][%d] serviceLogsOK", 200)
}
...
// Code gets the status code for the service logs not found response
func (o *ServiceLogsNotFound) Code() int {
	return 404
}

func (o *ServiceLogsNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /services/{id}/logs][%d] serviceLogsNotFound %s", 404, payload)
}
...
// Code gets the status code for the service logs internal server error response
func (o *ServiceLogsInternalServerError) Code() int {
	return 500
}

func (o *ServiceLogsInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /services/{id}/logs][%d] serviceLogsInternalServerError %s", 500, payload)
}
...
// Code gets the status code for the service logs service unavailable response
func (o *ServiceLogsServiceUnavailable) Code() int {
	return 503
}

func (o *ServiceLogsServiceUnavailable) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /services/{id}/logs][%d] serviceLogsServiceUnavailable %s", 503, payload)
}
