...
func (o *ServiceListReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 503:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[GET /services] ServiceList", response, response.Code())
	}
}
...
// Code gets the status code for the service list o k response
func (o *ServiceListOK) Code() int {
	return 200
}

func (o *ServiceListOK) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /services][%d] serviceListOK %s", 200, payload)
}
...
// Code gets the status code for the service list internal server error response
func (o *ServiceListInternalServerError) Code() int {
	return 500
}

func (o *ServiceListInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /services][%d] serviceListInternalServerError %s", 500, payload)
}
...
// Code gets the status code for the service list service unavailable response
func (o *ServiceListServiceUnavailable) Code() int {
	return 503
}

func (o *ServiceListServiceUnavailable) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /services][%d] serviceListServiceUnavailable %s", 503, payload)
}
