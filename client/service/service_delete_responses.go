...
func (o *ServiceDeleteReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 503:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[DELETE /services/{id}] ServiceDelete", response, response.Code())
	}
}
...
// Code gets the status code for the service delete o k response
func (o *ServiceDeleteOK) Code() int {
	return 200
}
...
// Code gets the status code for the service delete not found response
func (o *ServiceDeleteNotFound) Code() int {
	return 404
}

func (o *ServiceDeleteNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /services/{id}][%d] serviceDeleteNotFound %s", 404, payload)
}
...
// Code gets the status code for the service delete internal server error response
func (o *ServiceDeleteInternalServerError) Code() int {
	return 500
}

func (o *ServiceDeleteInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /services/{id}][%d] serviceDeleteInternalServerError %s", 500, payload)
}
...
// Code gets the status code for the service delete service unavailable response
func (o *ServiceDeleteServiceUnavailable) Code() int {
	return 503
}

func (o *ServiceDeleteServiceUnavailable) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /services/{id}][%d] serviceDeleteServiceUnavailable %s", 503, payload)
}
