...
func (o *ServiceUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 503:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[POST /services/{id}/update] ServiceUpdate", response, response.Code())
	}
}
...
// Code gets the status code for the service update o k response
func (o *ServiceUpdateOK) Code() int {
	return 200
}

func (o *ServiceUpdateOK) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /services/{id}/update][%d] serviceUpdateOK %s", 200, payload)
}
...
// Code gets the status code for the service update bad request response
func (o *ServiceUpdateBadRequest) Code() int {
	return 400
}

func (o *ServiceUpdateBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /services/{id}/update][%d] serviceUpdateBadRequest %s", 400, payload)
}
...
// Code gets the status code for the service update not found response
func (o *ServiceUpdateNotFound) Code() int {
	return 404
}

func (o *ServiceUpdateNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /services/{id}/update][%d] serviceUpdateNotFound %s", 404, payload)
}
...
// Code gets the status code for the service update internal server error response
func (o *ServiceUpdateInternalServerError) Code() int {
	return 500
}

func (o *ServiceUpdateInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /services/{id}/update][%d] serviceUpdateInternalServerError %s", 500, payload)
}
...
// Code gets the status code for the service update service unavailable response
func (o *ServiceUpdateServiceUnavailable) Code() int {
	return 503
}

func (o *ServiceUpdateServiceUnavailable) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /services/{id}/update][%d] serviceUpdateServiceUnavailable %s", 503, payload)
}
...
*/
type ServiceUpdateParamsBodyAllOf1 any
