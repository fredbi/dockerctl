...
func (o *NodeDeleteReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 503:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[DELETE /nodes/{id}] NodeDelete", response, response.Code())
	}
}
...
// Code gets the status code for the node delete not found response
func (o *NodeDeleteNotFound) Code() int {
	return 404
}

func (o *NodeDeleteNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /nodes/{id}][%d] nodeDeleteNotFound %s", 404, payload)
}
...
// Code gets the status code for the node delete internal server error response
func (o *NodeDeleteInternalServerError) Code() int {
	return 500
}

func (o *NodeDeleteInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /nodes/{id}][%d] nodeDeleteInternalServerError %s", 500, payload)
}
...
// Code gets the status code for the node delete service unavailable response
func (o *NodeDeleteServiceUnavailable) Code() int {
	return 503
}

func (o *NodeDeleteServiceUnavailable) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /nodes/{id}][%d] nodeDeleteServiceUnavailable %s", 503, payload)
}
