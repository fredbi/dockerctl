...
func (o *NodeUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 503:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[POST /nodes/{id}/update] NodeUpdate", response, response.Code())
	}
}
...
// Code gets the status code for the node update o k response
func (o *NodeUpdateOK) Code() int {
	return 200
}
...
// Code gets the status code for the node update bad request response
func (o *NodeUpdateBadRequest) Code() int {
	return 400
}

func (o *NodeUpdateBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /nodes/{id}/update][%d] nodeUpdateBadRequest %s", 400, payload)
}
...
// Code gets the status code for the node update not found response
func (o *NodeUpdateNotFound) Code() int {
	return 404
}

func (o *NodeUpdateNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /nodes/{id}/update][%d] nodeUpdateNotFound %s", 404, payload)
}
...
// Code gets the status code for the node update internal server error response
func (o *NodeUpdateInternalServerError) Code() int {
	return 500
}

func (o *NodeUpdateInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /nodes/{id}/update][%d] nodeUpdateInternalServerError %s", 500, payload)
}
...
// Code gets the status code for the node update service unavailable response
func (o *NodeUpdateServiceUnavailable) Code() int {
	return 503
}

func (o *NodeUpdateServiceUnavailable) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /nodes/{id}/update][%d] nodeUpdateServiceUnavailable %s", 503, payload)
}
