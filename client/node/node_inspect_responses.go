...
func (o *NodeInspectReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 503:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[GET /nodes/{id}] NodeInspect", response, response.Code())
	}
}
...
// Code gets the status code for the node inspect o k response
func (o *NodeInspectOK) Code() int {
	return 200
}

func (o *NodeInspectOK) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /nodes/{id}][%d] nodeInspectOK %s", 200, payload)
}
...
// Code gets the status code for the node inspect not found response
func (o *NodeInspectNotFound) Code() int {
	return 404
}

func (o *NodeInspectNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /nodes/{id}][%d] nodeInspectNotFound %s", 404, payload)
}
...
// Code gets the status code for the node inspect internal server error response
func (o *NodeInspectInternalServerError) Code() int {
	return 500
}

func (o *NodeInspectInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /nodes/{id}][%d] nodeInspectInternalServerError %s", 500, payload)
}
...
// Code gets the status code for the node inspect service unavailable response
func (o *NodeInspectServiceUnavailable) Code() int {
	return 503
}

func (o *NodeInspectServiceUnavailable) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /nodes/{id}][%d] nodeInspectServiceUnavailable %s", 503, payload)
}
