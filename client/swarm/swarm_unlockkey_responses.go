...
func (o *SwarmUnlockkeyReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 503:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[GET /swarm/unlockkey] SwarmUnlockkey", response, response.Code())
	}
}
...
// Code gets the status code for the swarm unlockkey o k response
func (o *SwarmUnlockkeyOK) Code() int {
	return 200
}

func (o *SwarmUnlockkeyOK) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /swarm/unlockkey][%d] swarmUnlockkeyOK %s", 200, payload)
}
...
// Code gets the status code for the swarm unlockkey internal server error response
func (o *SwarmUnlockkeyInternalServerError) Code() int {
	return 500
}

func (o *SwarmUnlockkeyInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /swarm/unlockkey][%d] swarmUnlockkeyInternalServerError %s", 500, payload)
}
...
// Code gets the status code for the swarm unlockkey service unavailable response
func (o *SwarmUnlockkeyServiceUnavailable) Code() int {
	return 503
}

func (o *SwarmUnlockkeyServiceUnavailable) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /swarm/unlockkey][%d] swarmUnlockkeyServiceUnavailable %s", 503, payload)
}
