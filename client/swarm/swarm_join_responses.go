...
func (o *SwarmJoinReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 503:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[POST /swarm/join] SwarmJoin", response, response.Code())
	}
}
...
// Code gets the status code for the swarm join o k response
func (o *SwarmJoinOK) Code() int {
	return 200
}
...
// Code gets the status code for the swarm join bad request response
func (o *SwarmJoinBadRequest) Code() int {
	return 400
}

func (o *SwarmJoinBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /swarm/join][%d] swarmJoinBadRequest %s", 400, payload)
}
...
// Code gets the status code for the swarm join internal server error response
func (o *SwarmJoinInternalServerError) Code() int {
	return 500
}

func (o *SwarmJoinInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /swarm/join][%d] swarmJoinInternalServerError %s", 500, payload)
}
...
// Code gets the status code for the swarm join service unavailable response
func (o *SwarmJoinServiceUnavailable) Code() int {
	return 503
}

func (o *SwarmJoinServiceUnavailable) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /swarm/join][%d] swarmJoinServiceUnavailable %s", 503, payload)
}
