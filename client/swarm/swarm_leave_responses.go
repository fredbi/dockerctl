...
func (o *SwarmLeaveReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 503:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[POST /swarm/leave] SwarmLeave", response, response.Code())
	}
}
...
// Code gets the status code for the swarm leave o k response
func (o *SwarmLeaveOK) Code() int {
	return 200
}
...
// Code gets the status code for the swarm leave internal server error response
func (o *SwarmLeaveInternalServerError) Code() int {
	return 500
}

func (o *SwarmLeaveInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /swarm/leave][%d] swarmLeaveInternalServerError %s", 500, payload)
}
...
// Code gets the status code for the swarm leave service unavailable response
func (o *SwarmLeaveServiceUnavailable) Code() int {
	return 503
}

func (o *SwarmLeaveServiceUnavailable) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /swarm/leave][%d] swarmLeaveServiceUnavailable %s", 503, payload)
}
