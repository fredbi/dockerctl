...
func (o *SwarmInitReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 503:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[POST /swarm/init] SwarmInit", response, response.Code())
	}
}
...
// Code gets the status code for the swarm init o k response
func (o *SwarmInitOK) Code() int {
	return 200
}

func (o *SwarmInitOK) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /swarm/init][%d] swarmInitOK %s", 200, payload)
}
...
// Code gets the status code for the swarm init bad request response
func (o *SwarmInitBadRequest) Code() int {
	return 400
}

func (o *SwarmInitBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /swarm/init][%d] swarmInitBadRequest %s", 400, payload)
}
...
// Code gets the status code for the swarm init internal server error response
func (o *SwarmInitInternalServerError) Code() int {
	return 500
}

func (o *SwarmInitInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /swarm/init][%d] swarmInitInternalServerError %s", 500, payload)
}
...
// Code gets the status code for the swarm init service unavailable response
func (o *SwarmInitServiceUnavailable) Code() int {
	return 503
}

func (o *SwarmInitServiceUnavailable) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /swarm/init][%d] swarmInitServiceUnavailable %s", 503, payload)
}
