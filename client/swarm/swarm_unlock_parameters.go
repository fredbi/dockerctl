...
SwarmUnlockParams contains all the parameters to send to the API endpoint
	...
	for the swarm unlock operation.
...
// WithDefaults hydrates default values in the swarm unlock params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *SwarmUnlockParams) WithDefaults() *SwarmUnlockParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the swarm unlock params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *SwarmUnlockParams) SetDefaults() {
