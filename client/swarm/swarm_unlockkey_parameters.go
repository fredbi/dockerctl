...
SwarmUnlockkeyParams contains all the parameters to send to the API endpoint
	...
	for the swarm unlockkey operation.
...
// WithDefaults hydrates default values in the swarm unlockkey params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *SwarmUnlockkeyParams) WithDefaults() *SwarmUnlockkeyParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the swarm unlockkey params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *SwarmUnlockkeyParams) SetDefaults() {
