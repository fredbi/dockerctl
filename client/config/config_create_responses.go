...
func (o *ConfigCreateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 503:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[POST /configs/create] ConfigCreate", response, response.Code())
	}
}
...
// Code gets the status code for the config create created response
func (o *ConfigCreateCreated) Code() int {
	return 201
}

func (o *ConfigCreateCreated) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /configs/create][%d] configCreateCreated %s", 201, payload)
}
...
// Code gets the status code for the config create conflict response
func (o *ConfigCreateConflict) Code() int {
	return 409
}

func (o *ConfigCreateConflict) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /configs/create][%d] configCreateConflict %s", 409, payload)
}
...
// Code gets the status code for the config create internal server error response
func (o *ConfigCreateInternalServerError) Code() int {
	return 500
}

func (o *ConfigCreateInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /configs/create][%d] configCreateInternalServerError %s", 500, payload)
}
...
// Code gets the status code for the config create service unavailable response
func (o *ConfigCreateServiceUnavailable) Code() int {
	return 503
}

func (o *ConfigCreateServiceUnavailable) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /configs/create][%d] configCreateServiceUnavailable %s", 503, payload)
}
...
*/
type ConfigCreateParamsBodyAllOf1 any
