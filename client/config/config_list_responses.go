...
func (o *ConfigListReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 503:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[GET /configs] ConfigList", response, response.Code())
	}
}
...
// Code gets the status code for the config list o k response
func (o *ConfigListOK) Code() int {
	return 200
}

func (o *ConfigListOK) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /configs][%d] configListOK %s", 200, payload)
}
...
// Code gets the status code for the config list internal server error response
func (o *ConfigListInternalServerError) Code() int {
	return 500
}

func (o *ConfigListInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /configs][%d] configListInternalServerError %s", 500, payload)
}
...
// Code gets the status code for the config list service unavailable response
func (o *ConfigListServiceUnavailable) Code() int {
	return 503
}

func (o *ConfigListServiceUnavailable) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /configs][%d] configListServiceUnavailable %s", 503, payload)
}
