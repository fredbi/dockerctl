...
func (o *ConfigDeleteReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 503:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[DELETE /configs/{id}] ConfigDelete", response, response.Code())
	}
}
...
// Code gets the status code for the config delete no content response
func (o *ConfigDeleteNoContent) Code() int {
	return 204
}
...
// Code gets the status code for the config delete not found response
func (o *ConfigDeleteNotFound) Code() int {
	return 404
}

func (o *ConfigDeleteNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /configs/{id}][%d] configDeleteNotFound %s", 404, payload)
}
...
// Code gets the status code for the config delete internal server error response
func (o *ConfigDeleteInternalServerError) Code() int {
	return 500
}

func (o *ConfigDeleteInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /configs/{id}][%d] configDeleteInternalServerError %s", 500, payload)
}
...
// Code gets the status code for the config delete service unavailable response
func (o *ConfigDeleteServiceUnavailable) Code() int {
	return 503
}

func (o *ConfigDeleteServiceUnavailable) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /configs/{id}][%d] configDeleteServiceUnavailable %s", 503, payload)
}
