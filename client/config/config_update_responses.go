...
func (o *ConfigUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 503:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[POST /configs/{id}/update] ConfigUpdate", response, response.Code())
	}
}
...
// Code gets the status code for the config update o k response
func (o *ConfigUpdateOK) Code() int {
	return 200
}
...
// Code gets the status code for the config update bad request response
func (o *ConfigUpdateBadRequest) Code() int {
	return 400
}

func (o *ConfigUpdateBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /configs/{id}/update][%d] configUpdateBadRequest %s", 400, payload)
}
...
// Code gets the status code for the config update not found response
func (o *ConfigUpdateNotFound) Code() int {
	return 404
}

func (o *ConfigUpdateNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /configs/{id}/update][%d] configUpdateNotFound %s", 404, payload)
}
...
// Code gets the status code for the config update internal server error response
func (o *ConfigUpdateInternalServerError) Code() int {
	return 500
}

func (o *ConfigUpdateInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /configs/{id}/update][%d] configUpdateInternalServerError %s", 500, payload)
}
...
// Code gets the status code for the config update service unavailable response
func (o *ConfigUpdateServiceUnavailable) Code() int {
	return 503
}

func (o *ConfigUpdateServiceUnavailable) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /configs/{id}/update][%d] configUpdateServiceUnavailable %s", 503, payload)
}
