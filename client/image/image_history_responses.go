...
func (o *ImageHistoryReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 500:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[GET /images/{name}/history] ImageHistory", response, response.Code())
	}
}
...
// Code gets the status code for the image history o k response
func (o *ImageHistoryOK) Code() int {
	return 200
}

func (o *ImageHistoryOK) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /images/{name}/history][%d] imageHistoryOK %s", 200, payload)
}
...
// Code gets the status code for the image history not found response
func (o *ImageHistoryNotFound) Code() int {
	return 404
}

func (o *ImageHistoryNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /images/{name}/history][%d] imageHistoryNotFound %s", 404, payload)
}
...
// Code gets the status code for the image history internal server error response
func (o *ImageHistoryInternalServerError) Code() int {
	return 500
}

func (o *ImageHistoryInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /images/{name}/history][%d] imageHistoryInternalServerError %s", 500, payload)
}
