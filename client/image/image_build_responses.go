...
func (o *ImageBuildReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 500:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[POST /build] ImageBuild", response, response.Code())
	}
}
...
// Code gets the status code for the image build o k response
func (o *ImageBuildOK) Code() int {
	return 200
}
...
// Code gets the status code for the image build bad request response
func (o *ImageBuildBadRequest) Code() int {
	return 400
}

func (o *ImageBuildBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /build][%d] imageBuildBadRequest %s", 400, payload)
}
...
// Code gets the status code for the image build internal server error response
func (o *ImageBuildInternalServerError) Code() int {
	return 500
}

func (o *ImageBuildInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /build][%d] imageBuildInternalServerError %s", 500, payload)
}
