...
func (o *ImageSearchReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 500:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[GET /images/search] ImageSearch", response, response.Code())
	}
}
...
// Code gets the status code for the image search o k response
func (o *ImageSearchOK) Code() int {
	return 200
}

func (o *ImageSearchOK) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /images/search][%d] imageSearchOK %s", 200, payload)
}
...
// Code gets the status code for the image search internal server error response
func (o *ImageSearchInternalServerError) Code() int {
	return 500
}

func (o *ImageSearchInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /images/search][%d] imageSearchInternalServerError %s", 500, payload)
}
