...
func (o *ImageCommitReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 500:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[POST /commit] ImageCommit", response, response.Code())
	}
}
...
// Code gets the status code for the image commit created response
func (o *ImageCommitCreated) Code() int {
	return 201
}

func (o *ImageCommitCreated) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /commit][%d] imageCommitCreated %s", 201, payload)
}
...
// Code gets the status code for the image commit not found response
func (o *ImageCommitNotFound) Code() int {
	return 404
}

func (o *ImageCommitNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /commit][%d] imageCommitNotFound %s", 404, payload)
}
...
// Code gets the status code for the image commit internal server error response
func (o *ImageCommitInternalServerError) Code() int {
	return 500
}

func (o *ImageCommitInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /commit][%d] imageCommitInternalServerError %s", 500, payload)
}
