...
func (o *ImageGetReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 500:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[GET /images/{name}/get] ImageGet", response, response.Code())
	}
}
...
// Code gets the status code for the image get o k response
func (o *ImageGetOK) Code() int {
	return 200
}

func (o *ImageGetOK) Error() string {
	return fmt.Sprintf("[GET /images/{name}/get][%d] imageGetOK", 200)
}
...
// Code gets the status code for the image get internal server error response
func (o *ImageGetInternalServerError) Code() int {
	return 500
}

func (o *ImageGetInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /images/{name}/get][%d] imageGetInternalServerError %s", 500, payload)
}
