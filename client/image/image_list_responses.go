...
func (o *ImageListReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 500:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[GET /images/json] ImageList", response, response.Code())
	}
}
...
// Code gets the status code for the image list o k response
func (o *ImageListOK) Code() int {
	return 200
}

func (o *ImageListOK) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /images/json][%d] imageListOK %s", 200, payload)
}
...
// Code gets the status code for the image list internal server error response
func (o *ImageListInternalServerError) Code() int {
	return 500
}

func (o *ImageListInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /images/json][%d] imageListInternalServerError %s", 500, payload)
}
