...
func (o *ImageCreateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 500:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[POST /images/create] ImageCreate", response, response.Code())
	}
}
...
// Code gets the status code for the image create o k response
func (o *ImageCreateOK) Code() int {
	return 200
}
...
// Code gets the status code for the image create not found response
func (o *ImageCreateNotFound) Code() int {
	return 404
}

func (o *ImageCreateNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /images/create][%d] imageCreateNotFound %s", 404, payload)
}
...
// Code gets the status code for the image create internal server error response
func (o *ImageCreateInternalServerError) Code() int {
	return 500
}

func (o *ImageCreateInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /images/create][%d] imageCreateInternalServerError %s", 500, payload)
}
