...
func (o *BuildPruneReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 500:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[POST /build/prune] BuildPrune", response, response.Code())
	}
}
...
// Code gets the status code for the build prune o k response
func (o *BuildPruneOK) Code() int {
	return 200
}

func (o *BuildPruneOK) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /build/prune][%d] buildPruneOK %s", 200, payload)
}
...
// Code gets the status code for the build prune internal server error response
func (o *BuildPruneInternalServerError) Code() int {
	return 500
}

func (o *BuildPruneInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /build/prune][%d] buildPruneInternalServerError %s", 500, payload)
}
