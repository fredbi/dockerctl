...
func (o *ExecStartReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 409:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[POST /exec/{id}/start] ExecStart", response, response.Code())
	}
}
...
func (o *ExecStartNotFound) Error() string {
	...
	return fmt.Sprintf("[POST /exec/{id}/start][%d] execStartNotFound %s", 404, payload)
}
...
func (o *ExecStartConflict) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /exec/{id}/start][%d] execStartConflict %s", 409, payload)
}
