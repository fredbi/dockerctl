...
func (o *ExecResizeReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 404:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[POST /exec/{id}/resize] ExecResize", response, response.Code())
	}
}
...
func (o *ExecResizeNotFound) Error() string {
	...
	return fmt.Sprintf("[POST /exec/{id}/resize][%d] execResizeNotFound %s", 404, payload)
}
