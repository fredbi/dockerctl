...
func (o *ContainerExecReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 500:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[POST /containers/{id}/exec] ContainerExec", response, response.Code())
	}
}
...
func (o *ContainerExecCreated) Error() string {
	...
	return fmt.Sprintf("[POST /containers/{id}/exec][%d] containerExecCreated %s", 201, payload)
}
...
func (o *ContainerExecNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /containers/{id}/exec][%d] containerExecNotFound %s", 404, payload)
}
...
func (o *ContainerExecConflict) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /containers/{id}/exec][%d] containerExecConflict %s", 409, payload)
}
...
func (o *ContainerExecInternalServerError) Code() int {
	return 500
}

func (o *ContainerExecInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /containers/{id}/exec][%d] containerExecInternalServerError %s", 500, payload)
}
