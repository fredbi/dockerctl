...
func (o *GetPluginPrivilegesReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 500:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[GET /plugins/privileges] GetPluginPrivileges", response, response.Code())
	}
}
...
// Code gets the status code for the get plugin privileges o k response
func (o *GetPluginPrivilegesOK) Code() int {
	return 200
}

func (o *GetPluginPrivilegesOK) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /plugins/privileges][%d] getPluginPrivilegesOK %s", 200, payload)
}
...
// Code gets the status code for the get plugin privileges internal server error response
func (o *GetPluginPrivilegesInternalServerError) Code() int {
	return 500
}

func (o *GetPluginPrivilegesInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /plugins/privileges][%d] getPluginPrivilegesInternalServerError %s", 500, payload)
}
