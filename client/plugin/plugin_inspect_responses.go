...
func (o *PluginInspectReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 500:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[GET /plugins/{name}/json] PluginInspect", response, response.Code())
	}
}
...
// Code gets the status code for the plugin inspect o k response
func (o *PluginInspectOK) Code() int {
	return 200
}

func (o *PluginInspectOK) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /plugins/{name}/json][%d] pluginInspectOK %s", 200, payload)
}
...
// Code gets the status code for the plugin inspect not found response
func (o *PluginInspectNotFound) Code() int {
	return 404
}

func (o *PluginInspectNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /plugins/{name}/json][%d] pluginInspectNotFound %s", 404, payload)
}
...
// Code gets the status code for the plugin inspect internal server error response
func (o *PluginInspectInternalServerError) Code() int {
	return 500
}

func (o *PluginInspectInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /plugins/{name}/json][%d] pluginInspectInternalServerError %s", 500, payload)
}
