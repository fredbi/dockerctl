...
func (o *PluginListReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 500:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[GET /plugins] PluginList", response, response.Code())
	}
}
...
// Code gets the status code for the plugin list o k response
func (o *PluginListOK) Code() int {
	return 200
}

func (o *PluginListOK) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /plugins][%d] pluginListOK %s", 200, payload)
}
...
// Code gets the status code for the plugin list internal server error response
func (o *PluginListInternalServerError) Code() int {
	return 500
}

func (o *PluginListInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /plugins][%d] pluginListInternalServerError %s", 500, payload)
}
