...
func (o *PluginUpgradeReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 500:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[POST /plugins/{name}/upgrade] PluginUpgrade", response, response.Code())
	}
}
...
// Code gets the status code for the plugin upgrade no content response
func (o *PluginUpgradeNoContent) Code() int {
	return 204
}
...
// Code gets the status code for the plugin upgrade not found response
func (o *PluginUpgradeNotFound) Code() int {
	return 404
}

func (o *PluginUpgradeNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /plugins/{name}/upgrade][%d] pluginUpgradeNotFound %s", 404, payload)
}
...
// Code gets the status code for the plugin upgrade internal server error response
func (o *PluginUpgradeInternalServerError) Code() int {
	return 500
}

func (o *PluginUpgradeInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /plugins/{name}/upgrade][%d] pluginUpgradeInternalServerError %s", 500, payload)
}
