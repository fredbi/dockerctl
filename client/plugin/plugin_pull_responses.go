...
func (o *PluginPullReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 500:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[POST /plugins/pull] PluginPull", response, response.Code())
	}
}
...
// Code gets the status code for the plugin pull no content response
func (o *PluginPullNoContent) Code() int {
	return 204
}
...
// Code gets the status code for the plugin pull internal server error response
func (o *PluginPullInternalServerError) Code() int {
	return 500
}

func (o *PluginPullInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /plugins/pull][%d] pluginPullInternalServerError %s", 500, payload)
}
