...
func (o *PluginEnableReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 500:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[POST /plugins/{name}/enable] PluginEnable", response, response.Code())
	}
}
...
// Code gets the status code for the plugin enable o k response
func (o *PluginEnableOK) Code() int {
	return 200
}
...
// Code gets the status code for the plugin enable not found response
func (o *PluginEnableNotFound) Code() int {
	return 404
}

func (o *PluginEnableNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /plugins/{name}/enable][%d] pluginEnableNotFound %s", 404, payload)
}
...
// Code gets the status code for the plugin enable internal server error response
func (o *PluginEnableInternalServerError) Code() int {
	return 500
}

func (o *PluginEnableInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /plugins/{name}/enable][%d] pluginEnableInternalServerError %s", 500, payload)
}
