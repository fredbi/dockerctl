...
func (o *PluginDisableReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 500:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[POST /plugins/{name}/disable] PluginDisable", response, response.Code())
	}
}
...
// Code gets the status code for the plugin disable o k response
func (o *PluginDisableOK) Code() int {
	return 200
}
...
// Code gets the status code for the plugin disable not found response
func (o *PluginDisableNotFound) Code() int {
	return 404
}

func (o *PluginDisableNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /plugins/{name}/disable][%d] pluginDisableNotFound %s", 404, payload)
}
...
// Code gets the status code for the plugin disable internal server error response
func (o *PluginDisableInternalServerError) Code() int {
	return 500
}

func (o *PluginDisableInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /plugins/{name}/disable][%d] pluginDisableInternalServerError %s", 500, payload)
}
