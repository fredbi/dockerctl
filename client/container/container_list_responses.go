...
func (o *ContainerListReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 500:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[GET /containers/json] ContainerList", response, response.Code())
	}
}
...
// Code gets the status code for the container list o k response
func (o *ContainerListOK) Code() int {
	return 200
}

func (o *ContainerListOK) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /containers/json][%d] containerListOK %s", 200, payload)
}
...
// Code gets the status code for the container list bad request response
func (o *ContainerListBadRequest) Code() int {
	return 400
}

func (o *ContainerListBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /containers/json][%d] containerListBadRequest %s", 400, payload)
}
...
// Code gets the status code for the container list internal server error response
func (o *ContainerListInternalServerError) Code() int {
	return 500
}

func (o *ContainerListInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /containers/json][%d] containerListInternalServerError %s", 500, payload)
}
