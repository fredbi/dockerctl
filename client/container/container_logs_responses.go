...
func (o *ContainerLogsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 500:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[GET /containers/{id}/logs] ContainerLogs", response, response.Code())
	}
}
...
func (o *ContainerLogsOK) Error() string {
	return fmt.Sprintf("[GET /containers/{id}/logs][%d] containerLogsOK", 200)
}
...
func (o *ContainerLogsNotFound) Error() string {
	...
	return fmt.Sprintf("[GET /containers/{id}/logs][%d] containerLogsNotFound %s", 404, payload)
}
...
func (o *ContainerLogsInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /containers/{id}/logs][%d] containerLogsInternalServerError %s", 500, payload)
}
