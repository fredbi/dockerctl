...
func (o *ContainerRestartReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 500:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[POST /containers/{id}/restart] ContainerRestart", response, response.Code())
	}
}
...
// Code gets the status code for the container restart no content response
func (o *ContainerRestartNoContent) Code() int {
	return 204
}
...
// Code gets the status code for the container restart not found response
func (o *ContainerRestartNotFound) Code() int {
	return 404
}

func (o *ContainerRestartNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /containers/{id}/restart][%d] containerRestartNotFound %s", 404, payload)
}
...
// Code gets the status code for the container restart internal server error response
func (o *ContainerRestartInternalServerError) Code() int {
	return 500
}

func (o *ContainerRestartInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /containers/{id}/restart][%d] containerRestartInternalServerError %s", 500, payload)
}
