...
func (o *ContainerCreateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 500:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[POST /containers/create] ContainerCreate", response, response.Code())
	}
}
...
func (o *ContainerCreateCreated) Error() string {
	...
	return fmt.Sprintf("[POST /containers/create][%d] containerCreateCreated %s", 201, payload)
}
...
// Code gets the status code for the container create bad request response
func (o *ContainerCreateBadRequest) Code() int {
	return 400
}

func (o *ContainerCreateBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /containers/create][%d] containerCreateBadRequest %s", 400, payload)
}
...
// Code gets the status code for the container create not found response
func (o *ContainerCreateNotFound) Code() int {
	return 404
}

func (o *ContainerCreateNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /containers/create][%d] containerCreateNotFound %s", 404, payload)
}
...
// Code gets the status code for the container create conflict response
func (o *ContainerCreateConflict) Code() int {
	return 409
}

func (o *ContainerCreateConflict) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /containers/create][%d] containerCreateConflict %s", 409, payload)
}
...
// Code gets the status code for the container create internal server error response
func (o *ContainerCreateInternalServerError) Code() int {
	return 500
}

func (o *ContainerCreateInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /containers/create][%d] containerCreateInternalServerError %s", 500, payload)
}
