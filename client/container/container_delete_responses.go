...
func (o *ContainerDeleteReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 500:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[DELETE /containers/{id}] ContainerDelete", response, response.Code())
	}
}
...
// Code gets the status code for the container delete no content response
func (o *ContainerDeleteNoContent) Code() int {
	return 204
}
...
// Code gets the status code for the container delete bad request response
func (o *ContainerDeleteBadRequest) Code() int {
	return 400
}

func (o *ContainerDeleteBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /containers/{id}][%d] containerDeleteBadRequest %s", 400, payload)
}
...
// Code gets the status code for the container delete not found response
func (o *ContainerDeleteNotFound) Code() int {
	return 404
}

func (o *ContainerDeleteNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /containers/{id}][%d] containerDeleteNotFound %s", 404, payload)
}
...
// Code gets the status code for the container delete conflict response
func (o *ContainerDeleteConflict) Code() int {
	return 409
}

func (o *ContainerDeleteConflict) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /containers/{id}][%d] containerDeleteConflict %s", 409, payload)
}
...
// Code gets the status code for the container delete internal server error response
func (o *ContainerDeleteInternalServerError) Code() int {
	return 500
}

func (o *ContainerDeleteInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /containers/{id}][%d] containerDeleteInternalServerError %s", 500, payload)
}
