...
func (o *ContainerArchiveReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 500:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[GET /containers/{id}/archive] ContainerArchive", response, response.Code())
	}
}
...
// Code gets the status code for the container archive o k response
func (o *ContainerArchiveOK) Code() int {
	return 200
}
...
// Code gets the status code for the container archive bad request response
func (o *ContainerArchiveBadRequest) Code() int {
	return 400
}

func (o *ContainerArchiveBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /containers/{id}/archive][%d] containerArchiveBadRequest %s", 400, payload)
}
...
// Code gets the status code for the container archive not found response
func (o *ContainerArchiveNotFound) Code() int {
	return 404
}

func (o *ContainerArchiveNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /containers/{id}/archive][%d] containerArchiveNotFound %s", 404, payload)
}
...
// Code gets the status code for the container archive internal server error response
func (o *ContainerArchiveInternalServerError) Code() int {
	return 500
}

func (o *ContainerArchiveInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /containers/{id}/archive][%d] containerArchiveInternalServerError %s", 500, payload)
}
