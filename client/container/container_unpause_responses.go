...
func (o *ContainerUnpauseReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 500:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[POST /containers/{id}/unpause] ContainerUnpause", response, response.Code())
	}
}
...
// Code gets the status code for the container unpause no content response
func (o *ContainerUnpauseNoContent) Code() int {
	return 204
}
...
// Code gets the status code for the container unpause not found response
func (o *ContainerUnpauseNotFound) Code() int {
	return 404
}

func (o *ContainerUnpauseNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /containers/{id}/unpause][%d] containerUnpauseNotFound %s", 404, payload)
}
...
// Code gets the status code for the container unpause internal server error response
func (o *ContainerUnpauseInternalServerError) Code() int {
	return 500
}

func (o *ContainerUnpauseInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /containers/{id}/unpause][%d] containerUnpauseInternalServerError %s", 500, payload)
}
