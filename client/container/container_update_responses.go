...
func (o *ContainerUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 500:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[POST /containers/{id}/update] ContainerUpdate", response, response.Code())
	}
}
...
// Code gets the status code for the container update o k response
func (o *ContainerUpdateOK) Code() int {
	return 200
}

func (o *ContainerUpdateOK) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /containers/{id}/update][%d] containerUpdateOK %s", 200, payload)
}
...
// Code gets the status code for the container update not found response
func (o *ContainerUpdateNotFound) Code() int {
	return 404
}

func (o *ContainerUpdateNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /containers/{id}/update][%d] containerUpdateNotFound %s", 404, payload)
}
...
// Code gets the status code for the container update internal server error response
func (o *ContainerUpdateInternalServerError) Code() int {
	return 500
}

func (o *ContainerUpdateInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /containers/{id}/update][%d] containerUpdateInternalServerError %s", 500, payload)
}
