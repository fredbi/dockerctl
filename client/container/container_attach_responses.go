...
func (o *ContainerAttachReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 500:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[POST /containers/{id}/attach] ContainerAttach", response, response.Code())
	}
}
...
// Code gets the status code for the container attach switching protocols response
func (o *ContainerAttachSwitchingProtocols) Code() int {
	return 101
}
...
// Code gets the status code for the container attach o k response
func (o *ContainerAttachOK) Code() int {
	return 200
}
...
// Code gets the status code for the container attach bad request response
func (o *ContainerAttachBadRequest) Code() int {
	return 400
}

func (o *ContainerAttachBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /containers/{id}/attach][%d] containerAttachBadRequest %s", 400, payload)
}
...
// Code gets the status code for the container attach not found response
func (o *ContainerAttachNotFound) Code() int {
	return 404
}

func (o *ContainerAttachNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /containers/{id}/attach][%d] containerAttachNotFound %s", 404, payload)
}
...
// Code gets the status code for the container attach internal server error response
func (o *ContainerAttachInternalServerError) Code() int {
	return 500
}

func (o *ContainerAttachInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /containers/{id}/attach][%d] containerAttachInternalServerError %s", 500, payload)
}
