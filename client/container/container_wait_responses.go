...
func (o *ContainerWaitReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 500:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[POST /containers/{id}/wait] ContainerWait", response, response.Code())
	}
}
...
// Code gets the status code for the container wait o k response
func (o *ContainerWaitOK) Code() int {
	return 200
}

func (o *ContainerWaitOK) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /containers/{id}/wait][%d] containerWaitOK %s", 200, payload)
}
...
// Code gets the status code for the container wait not found response
func (o *ContainerWaitNotFound) Code() int {
	return 404
}

func (o *ContainerWaitNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /containers/{id}/wait][%d] containerWaitNotFound %s", 404, payload)
}
...
// Code gets the status code for the container wait internal server error response
func (o *ContainerWaitInternalServerError) Code() int {
	return 500
}

func (o *ContainerWaitInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /containers/{id}/wait][%d] containerWaitInternalServerError %s", 500, payload)
}
...
func (o *ContainerWaitOKBody) validateStatusCode(formats strfmt.Registry) error {
	...
	if err := validate.Required("containerWaitOK"+"."+"StatusCode", "body", o.StatusCode); err != nil {
		return err
	}
