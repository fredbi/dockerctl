...
func (o *ContainerExportReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 500:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[GET /containers/{id}/export] ContainerExport", response, response.Code())
	}
}
...
// Code gets the status code for the container export o k response
func (o *ContainerExportOK) Code() int {
	return 200
}
...
// Code gets the status code for the container export not found response
func (o *ContainerExportNotFound) Code() int {
	return 404
}

func (o *ContainerExportNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /containers/{id}/export][%d] containerExportNotFound %s", 404, payload)
}
...
// Code gets the status code for the container export internal server error response
func (o *ContainerExportInternalServerError) Code() int {
	return 500
}

func (o *ContainerExportInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /containers/{id}/export][%d] containerExportInternalServerError %s", 500, payload)
}
