...
func (o *ContainerPauseReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 500:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[POST /containers/{id}/pause] ContainerPause", response, response.Code())
	}
}
...
// Code gets the status code for the container pause no content response
func (o *ContainerPauseNoContent) Code() int {
	return 204
}
...
// Code gets the status code for the container pause not found response
func (o *ContainerPauseNotFound) Code() int {
	return 404
}

func (o *ContainerPauseNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /containers/{id}/pause][%d] containerPauseNotFound %s", 404, payload)
}
...
// Code gets the status code for the container pause internal server error response
func (o *ContainerPauseInternalServerError) Code() int {
	return 500
}

func (o *ContainerPauseInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /containers/{id}/pause][%d] containerPauseInternalServerError %s", 500, payload)
}
