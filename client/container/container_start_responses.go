...
func (o *ContainerStartReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 500:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[POST /containers/{id}/start] ContainerStart", response, response.Code())
	}
}
...
// Code gets the status code for the container start no content response
func (o *ContainerStartNoContent) Code() int {
	return 204
}
...
// Code gets the status code for the container start not modified response
func (o *ContainerStartNotModified) Code() int {
	return 304
}
...
// Code gets the status code for the container start not found response
func (o *ContainerStartNotFound) Code() int {
	return 404
}

func (o *ContainerStartNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /containers/{id}/start][%d] containerStartNotFound %s", 404, payload)
}
...
// Code gets the status code for the container start internal server error response
func (o *ContainerStartInternalServerError) Code() int {
	return 500
}

func (o *ContainerStartInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /containers/{id}/start][%d] containerStartInternalServerError %s", 500, payload)
}
