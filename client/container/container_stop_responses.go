...
func (o *ContainerStopReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 500:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[POST /containers/{id}/stop] ContainerStop", response, response.Code())
	}
}
...
// Code gets the status code for the container stop no content response
func (o *ContainerStopNoContent) Code() int {
	return 204
}
...
// Code gets the status code for the container stop not modified response
func (o *ContainerStopNotModified) Code() int {
	return 304
}
...
// Code gets the status code for the container stop not found response
func (o *ContainerStopNotFound) Code() int {
	return 404
}

func (o *ContainerStopNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /containers/{id}/stop][%d] containerStopNotFound %s", 404, payload)
}
...
// Code gets the status code for the container stop internal server error response
func (o *ContainerStopInternalServerError) Code() int {
	return 500
}

func (o *ContainerStopInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /containers/{id}/stop][%d] containerStopInternalServerError %s", 500, payload)
}
