...
func (o *ContainerPruneReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 500:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[POST /containers/prune] ContainerPrune", response, response.Code())
	}
}
...
// Code gets the status code for the container prune o k response
func (o *ContainerPruneOK) Code() int {
	return 200
}

func (o *ContainerPruneOK) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /containers/prune][%d] containerPruneOK %s", 200, payload)
}
...
// Code gets the status code for the container prune internal server error response
func (o *ContainerPruneInternalServerError) Code() int {
	return 500
}

func (o *ContainerPruneInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /containers/prune][%d] containerPruneInternalServerError %s", 500, payload)
}
