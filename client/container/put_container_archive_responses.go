...
func (o *PutContainerArchiveReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 500:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[PUT /containers/{id}/archive] PutContainerArchive", response, response.Code())
	}
}
...
// Code gets the status code for the put container archive o k response
func (o *PutContainerArchiveOK) Code() int {
	return 200
}
...
// Code gets the status code for the put container archive bad request response
func (o *PutContainerArchiveBadRequest) Code() int {
	return 400
}

func (o *PutContainerArchiveBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /containers/{id}/archive][%d] putContainerArchiveBadRequest %s", 400, payload)
}
...
// Code gets the status code for the put container archive forbidden response
func (o *PutContainerArchiveForbidden) Code() int {
	return 403
}

func (o *PutContainerArchiveForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /containers/{id}/archive][%d] putContainerArchiveForbidden %s", 403, payload)
}
...
// Code gets the status code for the put container archive not found response
func (o *PutContainerArchiveNotFound) Code() int {
	return 404
}

func (o *PutContainerArchiveNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /containers/{id}/archive][%d] putContainerArchiveNotFound %s", 404, payload)
}
...
// Code gets the status code for the put container archive internal server error response
func (o *PutContainerArchiveInternalServerError) Code() int {
	return 500
}

func (o *PutContainerArchiveInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /containers/{id}/archive][%d] putContainerArchiveInternalServerError %s", 500, payload)
}
