...
func (o *ContainerInspectReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 500:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[GET /containers/{id}/json] ContainerInspect", response, response.Code())
	}
}
...
// Code gets the status code for the container inspect o k response
func (o *ContainerInspectOK) Code() int {
	return 200
}

func (o *ContainerInspectOK) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /containers/{id}/json][%d] containerInspectOK %s", 200, payload)
}
...
// Code gets the status code for the container inspect not found response
func (o *ContainerInspectNotFound) Code() int {
	return 404
}

func (o *ContainerInspectNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /containers/{id}/json][%d] containerInspectNotFound %s", 404, payload)
}
...
// Code gets the status code for the container inspect internal server error response
func (o *ContainerInspectInternalServerError) Code() int {
	return 500
}

func (o *ContainerInspectInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /containers/{id}/json][%d] containerInspectInternalServerError %s", 500, payload)
}
...
var containerInspectOKBodyStateTypeStatusPropEnum []any
...
func (o *ContainerInspectOKBodyState) validateStatusEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, containerInspectOKBodyStateTypeStatusPropEnum, true); err != nil {
		return err
	}
	return nil
}
