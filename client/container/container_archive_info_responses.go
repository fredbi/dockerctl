...
func (o *ContainerArchiveInfoReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 500:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[HEAD /containers/{id}/archive] ContainerArchiveInfo", response, response.Code())
	}
}
...
// Code gets the status code for the container archive info o k response
func (o *ContainerArchiveInfoOK) Code() int {
	return 200
}
...
func (o *ContainerArchiveInfoOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	// hydrates response header X-Docker-Container-Path-Stat
	hdrXDockerContainerPathStat := response.GetHeader("X-Docker-Container-Path-Stat")

	if hdrXDockerContainerPathStat != "" {
		o.XDockerContainerPathStat = hdrXDockerContainerPathStat
	}
...
// Code gets the status code for the container archive info bad request response
func (o *ContainerArchiveInfoBadRequest) Code() int {
	return 400
}

func (o *ContainerArchiveInfoBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[HEAD /containers/{id}/archive][%d] containerArchiveInfoBadRequest %s", 400, payload)
}
...
// Code gets the status code for the container archive info not found response
func (o *ContainerArchiveInfoNotFound) Code() int {
	return 404
}

func (o *ContainerArchiveInfoNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[HEAD /containers/{id}/archive][%d] containerArchiveInfoNotFound %s", 404, payload)
}
...
// Code gets the status code for the container archive info internal server error response
func (o *ContainerArchiveInfoInternalServerError) Code() int {
	return 500
}

func (o *ContainerArchiveInfoInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[HEAD /containers/{id}/archive][%d] containerArchiveInfoInternalServerError %s", 500, payload)
}
