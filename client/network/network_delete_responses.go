...
func (o *NetworkDeleteReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 500:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[DELETE /networks/{id}] NetworkDelete", response, response.Code())
	}
}
...
// Code gets the status code for the network delete no content response
func (o *NetworkDeleteNoContent) Code() int {
	return 204
}
...
// Code gets the status code for the network delete forbidden response
func (o *NetworkDeleteForbidden) Code() int {
	return 403
}

func (o *NetworkDeleteForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /networks/{id}][%d] networkDeleteForbidden %s", 403, payload)
}
...
// Code gets the status code for the network delete not found response
func (o *NetworkDeleteNotFound) Code() int {
	return 404
}

func (o *NetworkDeleteNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /networks/{id}][%d] networkDeleteNotFound %s", 404, payload)
}
...
// Code gets the status code for the network delete internal server error response
func (o *NetworkDeleteInternalServerError) Code() int {
	return 500
}

func (o *NetworkDeleteInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /networks/{id}][%d] networkDeleteInternalServerError %s", 500, payload)
}
