...
func (o *NetworkConnectReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 500:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[POST /networks/{id}/connect] NetworkConnect", response, response.Code())
	}
}
...
// Code gets the status code for the network connect o k response
func (o *NetworkConnectOK) Code() int {
	return 200
}
...
// Code gets the status code for the network connect forbidden response
func (o *NetworkConnectForbidden) Code() int {
	return 403
}

func (o *NetworkConnectForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /networks/{id}/connect][%d] networkConnectForbidden %s", 403, payload)
}
...
// Code gets the status code for the network connect not found response
func (o *NetworkConnectNotFound) Code() int {
	return 404
}

func (o *NetworkConnectNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /networks/{id}/connect][%d] networkConnectNotFound %s", 404, payload)
}
...
// Code gets the status code for the network connect internal server error response
func (o *NetworkConnectInternalServerError) Code() int {
	return 500
}

func (o *NetworkConnectInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /networks/{id}/connect][%d] networkConnectInternalServerError %s", 500, payload)
}
