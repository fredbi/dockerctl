...
func (o *NetworkCreateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 500:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[POST /networks/create] NetworkCreate", response, response.Code())
	}
}
...
// Code gets the status code for the network create created response
func (o *NetworkCreateCreated) Code() int {
	return 201
}

func (o *NetworkCreateCreated) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /networks/create][%d] networkCreateCreated %s", 201, payload)
}
...
// Code gets the status code for the network create forbidden response
func (o *NetworkCreateForbidden) Code() int {
	return 403
}

func (o *NetworkCreateForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /networks/create][%d] networkCreateForbidden %s", 403, payload)
}
...
// Code gets the status code for the network create not found response
func (o *NetworkCreateNotFound) Code() int {
	return 404
}

func (o *NetworkCreateNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /networks/create][%d] networkCreateNotFound %s", 404, payload)
}
...
// Code gets the status code for the network create internal server error response
func (o *NetworkCreateInternalServerError) Code() int {
	return 500
}

func (o *NetworkCreateInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /networks/create][%d] networkCreateInternalServerError %s", 500, payload)
}
