...
func (o *NetworkInspectReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 500:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[GET /networks/{id}] NetworkInspect", response, response.Code())
	}
}
...
// Code gets the status code for the network inspect o k response
func (o *NetworkInspectOK) Code() int {
	return 200
}

func (o *NetworkInspectOK) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /networks/{id}][%d] networkInspectOK %s", 200, payload)
}
...
// Code gets the status code for the network inspect not found response
func (o *NetworkInspectNotFound) Code() int {
	return 404
}

func (o *NetworkInspectNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /networks/{id}][%d] networkInspectNotFound %s", 404, payload)
}
...
// Code gets the status code for the network inspect internal server error response
func (o *NetworkInspectInternalServerError) Code() int {
	return 500
}

func (o *NetworkInspectInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /networks/{id}][%d] networkInspectInternalServerError %s", 500, payload)
}
