...
func (m *GenericResourcesItems0) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	...
	if err := m.contextValidateDiscreteResourceSpec(ctx, formats); err != nil {
		res = append(res, err)
	}

	if err := m.contextValidateNamedResourceSpec(ctx, formats); err != nil {
		res = append(res, err)
	}
...
func (m *GenericResourcesItems0) contextValidateDiscreteResourceSpec(ctx context.Context, formats strfmt.Registry) error {
...
func (m *GenericResourcesItems0) contextValidateNamedResourceSpec(ctx context.Context, formats strfmt.Registry) error {
...
func (m *GenericResourcesItems0DiscreteResourceSpec) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
...
func (m *GenericResourcesItems0NamedResourceSpec) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
