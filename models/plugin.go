...
func (m *PluginConfig) validateIpcHost(formats strfmt.Registry) error {
	...
	if err := validate.Required("Config"+"."+"IpcHost", "body", m.IpcHost); err != nil {
		return err
	}
...
func (m *PluginConfig) validatePidHost(formats strfmt.Registry) error {
	...
	if err := validate.Required("Config"+"."+"PidHost", "body", m.PidHost); err != nil {
		return err
	}
...
var pluginConfigInterfaceTypeProtocolSchemePropEnum []any
...
func (m *PluginConfigLinux) validateAllowAllDevices(formats strfmt.Registry) error {
	...
	if err := validate.Required("Config"+"."+"Linux"+"."+"AllowAllDevices", "body", m.AllowAllDevices); err != nil {
		return err
	}
