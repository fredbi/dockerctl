...
func (m *Mount) validateTypeEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, mountTypeTypePropEnum, true); err != nil {
		return err
	}
	return nil
}
...
var mountBindOptionsTypePropagationPropEnum []any
...
func (m *MountBindOptions) validatePropagationEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, mountBindOptionsTypePropagationPropEnum, true); err != nil {
		return err
	}
	return nil
}
...
func (m *MountVolumeOptions) contextValidateDriverConfig(ctx context.Context, formats strfmt.Registry) error {
