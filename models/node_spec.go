...
// NodeSpec node spec
// Example: {"Availability":"active","Labels":{"foo":"bar"},"Name":"node-name","Role":"manager"}
//
...
var nodeSpecTypeAvailabilityPropEnum []any
...
func (m *NodeSpec) validateAvailabilityEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, nodeSpecTypeAvailabilityPropEnum, true); err != nil {
		return err
	}
	return nil
}
...
var nodeSpecTypeRolePropEnum []any
...
func (m *NodeSpec) validateRoleEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, nodeSpecTypeRolePropEnum, true); err != nil {
		return err
	}
	return nil
}
