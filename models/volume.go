...
var volumeTypeScopePropEnum []any
...
func (m *VolumeUsageData) validateRefCount(formats strfmt.Registry) error {
	...
	if err := validate.Required("UsageData"+"."+"RefCount", "body", m.RefCount); err != nil {
		return err
	}
...
func (m *VolumeUsageData) validateSize(formats strfmt.Registry) error {
	...
	if err := validate.Required("UsageData"+"."+"Size", "body", m.Size); err != nil {
		return err
	}
