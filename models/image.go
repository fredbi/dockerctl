...
func (m *Image) validateArchitecture(formats strfmt.Registry) error {
	...
	if err := validate.RequiredString("Architecture", "body", m.Architecture); err != nil {
		return err
	}
...
func (m *Image) validateComment(formats strfmt.Registry) error {
	...
	if err := validate.RequiredString("Comment", "body", m.Comment); err != nil {
		return err
	}
...
func (m *Image) validateContainer(formats strfmt.Registry) error {
	...
	if err := validate.RequiredString("Container", "body", m.Container); err != nil {
		return err
	}
...
func (m *Image) validateCreated(formats strfmt.Registry) error {
	...
	if err := validate.RequiredString("Created", "body", m.Created); err != nil {
		return err
	}
...
func (m *Image) validateDockerVersion(formats strfmt.Registry) error {
	...
	if err := validate.RequiredString("DockerVersion", "body", m.DockerVersion); err != nil {
		return err
	}
...
func (m *Image) validateParent(formats strfmt.Registry) error {
	...
	if err := validate.RequiredString("Parent", "body", m.Parent); err != nil {
		return err
	}
...
func (m *Image) contextValidateConfig(ctx context.Context, formats strfmt.Registry) error {
...
func (m *Image) contextValidateContainerConfig(ctx context.Context, formats strfmt.Registry) error {
...
func (m *Image) contextValidateGraphDriver(ctx context.Context, formats strfmt.Registry) error {
...
func (m *Image) contextValidateMetadata(ctx context.Context, formats strfmt.Registry) error {
...
func (m *Image) contextValidateRootFS(ctx context.Context, formats strfmt.Registry) error {
