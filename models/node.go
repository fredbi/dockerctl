...
func (m *Node) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	...
	if err := m.contextValidateManagerStatus(ctx, formats); err != nil {
		res = append(res, err)
	}
...
func (m *Node) contextValidateDescription(ctx context.Context, formats strfmt.Registry) error {
...
func (m *Node) contextValidateManagerStatus(ctx context.Context, formats strfmt.Registry) error {
