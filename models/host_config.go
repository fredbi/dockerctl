...
func (m *HostConfig) UnmarshalJSON(raw []byte) error {
	...
	m.CgroupnsMode = dataAO1.CgroupnsMode
...
func (m HostConfig) MarshalJSON() ([]byte, error) {
	...
	dataAO1.CgroupnsMode = m.CgroupnsMode
...
var hostConfigTypeCgroupnsModePropEnum []any
...
func init() {
	...
	for _, v := range res {
		hostConfigTypeCgroupnsModePropEnum = append(hostConfigTypeCgroupnsModePropEnum, v)
	}
}

// property enum
func (m *HostConfig) validateCgroupnsModeEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, hostConfigTypeCgroupnsModePropEnum, true); err != nil {
		return err
	}
	return nil
}
...
func (m *HostConfig) validateCgroupnsMode(formats strfmt.Registry) error {
	...
	// value enum
	if err := m.validateCgroupnsModeEnum("CgroupnsMode", "body", m.CgroupnsMode); err != nil {
		return err
	}
...
var hostConfigAO1LogConfigTypeTypePropEnum []any
...
func (m *HostConfigAO1LogConfig) validateTypeEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, hostConfigAO1LogConfigTypeTypePropEnum, true); err != nil {
		return err
	}
	return nil
}
