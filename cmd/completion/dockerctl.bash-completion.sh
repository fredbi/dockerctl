...
__dockerctl_handle_go_custom_completion()
{
    ...
    # Calling ${words[0]} instead of directly dockerctl allows handling aliases
    args=("${words[@]:1}")
    # Disable ActiveHelp which is not supported for bash completion v1
    requestComp="DOCKERCTL_ACTIVE_HELP=0 ${words[0]} __completeNoDesc ${args[*]}"
...
_dockerctl_container_ContainerCreate()
{
    ...
    flags+=("--containerCreateBody.HostConfig.AutoRemove")
    flags+=("--containerCreateBody.HostConfig.BlkioWeight=")
    two_word_flags+=("--containerCreateBody.HostConfig.BlkioWeight")
    flags+=("--containerCreateBody.HostConfig.Cgroup=")
    two_word_flags+=("--containerCreateBody.HostConfig.Cgroup")
    flags+=("--containerCreateBody.HostConfig.CgroupParent=")
    two_word_flags+=("--containerCreateBody.HostConfig.CgroupParent")
    flags+=("--containerCreateBody.HostConfig.CgroupnsMode=")
    two_word_flags+=("--containerCreateBody.HostConfig.CgroupnsMode")
    flags_with_completion+=("--containerCreateBody.HostConfig.CgroupnsMode")
    flags_completion+=("__dockerctl_handle_go_custom_completion")
    flags+=("--containerCreateBody.HostConfig.ContainerIDFile=")
    two_word_flags+=("--containerCreateBody.HostConfig.ContainerIDFile")
    flags+=("--containerCreateBody.HostConfig.CpuCount=")
    two_word_flags+=("--containerCreateBody.HostConfig.CpuCount")
    flags+=("--containerCreateBody.HostConfig.CpuPercent=")
    two_word_flags+=("--containerCreateBody.HostConfig.CpuPercent")
    flags+=("--containerCreateBody.HostConfig.CpuPeriod=")
    two_word_flags+=("--containerCreateBody.HostConfig.CpuPeriod")
    flags+=("--containerCreateBody.HostConfig.CpuQuota=")
    two_word_flags+=("--containerCreateBody.HostConfig.CpuQuota")
    flags+=("--containerCreateBody.HostConfig.CpuRealtimePeriod=")
    two_word_flags+=("--containerCreateBody.HostConfig.CpuRealtimePeriod")
    flags+=("--containerCreateBody.HostConfig.CpuRealtimeRuntime=")
    two_word_flags+=("--containerCreateBody.HostConfig.CpuRealtimeRuntime")
    flags+=("--containerCreateBody.HostConfig.CpuShares=")
    two_word_flags+=("--containerCreateBody.HostConfig.CpuShares")
    flags+=("--containerCreateBody.HostConfig.CpusetCpus=")
    two_word_flags+=("--containerCreateBody.HostConfig.CpusetCpus")
    flags+=("--containerCreateBody.HostConfig.CpusetMems=")
    two_word_flags+=("--containerCreateBody.HostConfig.CpusetMems")
    flags+=("--containerCreateBody.HostConfig.IOMaximumBandwidth=")
    two_word_flags+=("--containerCreateBody.HostConfig.IOMaximumBandwidth")
    flags+=("--containerCreateBody.HostConfig.IOMaximumIOps=")
    two_word_flags+=("--containerCreateBody.HostConfig.IOMaximumIOps")
    flags+=("--containerCreateBody.HostConfig.Init")
    flags+=("--containerCreateBody.HostConfig.IpcMode=")
    two_word_flags+=("--containerCreateBody.HostConfig.IpcMode")
    flags+=("--containerCreateBody.HostConfig.Isolation=")
    two_word_flags+=("--containerCreateBody.HostConfig.Isolation")
    flags_with_completion+=("--containerCreateBody.HostConfig.Isolation")
    flags_completion+=("__dockerctl_handle_go_custom_completion")
    flags+=("--containerCreateBody.HostConfig.KernelMemory=")
    two_word_flags+=("--containerCreateBody.HostConfig.KernelMemory")
    flags+=("--containerCreateBody.HostConfig.KernelMemoryTCP=")
    two_word_flags+=("--containerCreateBody.HostConfig.KernelMemoryTCP")
    flags+=("--containerCreateBody.HostConfig.LogConfig.Type=")
    two_word_flags+=("--containerCreateBody.HostConfig.LogConfig.Type")
    flags_with_completion+=("--containerCreateBody.HostConfig.LogConfig.Type")
    flags_completion+=("__dockerctl_handle_go_custom_completion")
    flags+=("--containerCreateBody.HostConfig.Memory=")
    two_word_flags+=("--containerCreateBody.HostConfig.Memory")
    flags+=("--containerCreateBody.HostConfig.MemoryReservation=")
    two_word_flags+=("--containerCreateBody.HostConfig.MemoryReservation")
    flags+=("--containerCreateBody.HostConfig.MemorySwap=")
    two_word_flags+=("--containerCreateBody.HostConfig.MemorySwap")
    flags+=("--containerCreateBody.HostConfig.MemorySwappiness=")
    two_word_flags+=("--containerCreateBody.HostConfig.MemorySwappiness")
    flags+=("--containerCreateBody.HostConfig.NanoCPUs=")
    two_word_flags+=("--containerCreateBody.HostConfig.NanoCPUs")
    flags+=("--containerCreateBody.HostConfig.NetworkMode=")
    two_word_flags+=("--containerCreateBody.HostConfig.NetworkMode")
    flags+=("--containerCreateBody.HostConfig.OomKillDisable")
    flags+=("--containerCreateBody.HostConfig.OomScoreAdj=")
    two_word_flags+=("--containerCreateBody.HostConfig.OomScoreAdj")
    flags+=("--containerCreateBody.HostConfig.PidMode=")
    two_word_flags+=("--containerCreateBody.HostConfig.PidMode")
    flags+=("--containerCreateBody.HostConfig.PidsLimit=")
    two_word_flags+=("--containerCreateBody.HostConfig.PidsLimit")
    flags+=("--containerCreateBody.HostConfig.Privileged")
    flags+=("--containerCreateBody.HostConfig.PublishAllPorts")
    flags+=("--containerCreateBody.HostConfig.ReadonlyRootfs")
    flags+=("--containerCreateBody.HostConfig.RestartPolicy.MaximumRetryCount=")
    two_word_flags+=("--containerCreateBody.HostConfig.RestartPolicy.MaximumRetryCount")
    flags+=("--containerCreateBody.HostConfig.RestartPolicy.Name=")
    two_word_flags+=("--containerCreateBody.HostConfig.RestartPolicy.Name")
    flags_with_completion+=("--containerCreateBody.HostConfig.RestartPolicy.Name")
    flags_completion+=("__dockerctl_handle_go_custom_completion")
    flags+=("--containerCreateBody.HostConfig.Runtime=")
    two_word_flags+=("--containerCreateBody.HostConfig.Runtime")
    flags+=("--containerCreateBody.HostConfig.ShmSize=")
    two_word_flags+=("--containerCreateBody.HostConfig.ShmSize")
    flags+=("--containerCreateBody.HostConfig.UTSMode=")
    two_word_flags+=("--containerCreateBody.HostConfig.UTSMode")
    flags+=("--containerCreateBody.HostConfig.UsernsMode=")
    two_word_flags+=("--containerCreateBody.HostConfig.UsernsMode")
    flags+=("--containerCreateBody.HostConfig.VolumeDriver=")
    two_word_flags+=("--containerCreateBody.HostConfig.VolumeDriver")
...
_dockerctl_container_ContainerUpdate()
{
    ...
    flags+=("--containerUpdateBody.RestartPolicy.MaximumRetryCount=")
    two_word_flags+=("--containerUpdateBody.RestartPolicy.MaximumRetryCount")
    flags+=("--containerUpdateBody.RestartPolicy.Name=")
    two_word_flags+=("--containerUpdateBody.RestartPolicy.Name")
    flags_with_completion+=("--containerUpdateBody.RestartPolicy.Name")
    flags_completion+=("__dockerctl_handle_go_custom_completion")
    flags+=("--id=")
    two_word_flags+=("--id")
    flags+=("--update=")
...
_dockerctl_image_ImageBuild()
{
    ...
    flags_with_completion+=("--Content-type")
    flags_completion+=("__dockerctl_handle_go_custom_completion")
...
_dockerctl_markdown()
{
    last_command="dockerctl_markdown"
...
_dockerctl_node_NodeUpdate()
{
    ...
    flags_with_completion+=("--nodeSpec.Availability")
    flags_completion+=("__dockerctl_handle_go_custom_completion")
    flags+=("--nodeSpec.Name=")
    two_word_flags+=("--nodeSpec.Name")
    flags+=("--nodeSpec.Role=")
    two_word_flags+=("--nodeSpec.Role")
    flags_with_completion+=("--nodeSpec.Role")
    flags_completion+=("__dockerctl_handle_go_custom_completion")
    flags+=("--version=")
    two_word_flags+=("--version")
    flags+=("--base-path=")
...
_dockerctl_service_ServiceCreate()
{
    ...
    flags_with_completion+=("--serviceCreateBody.EndpointSpec.Mode")
    flags_completion+=("__dockerctl_handle_go_custom_completion")
    ...
    flags_with_completion+=("--serviceCreateBody.RollbackConfig.FailureAction")
    flags_completion+=("__dockerctl_handle_go_custom_completion")
    ...
    flags_with_completion+=("--serviceCreateBody.RollbackConfig.Order")
    flags_completion+=("__dockerctl_handle_go_custom_completion")
    ...
    flags_with_completion+=("--serviceCreateBody.TaskTemplate.ContainerSpec.Isolation")
    flags_completion+=("__dockerctl_handle_go_custom_completion")
    ...
    flags_with_completion+=("--serviceCreateBody.TaskTemplate.RestartPolicy.Condition")
    flags_completion+=("__dockerctl_handle_go_custom_completion")
    ...
    flags_with_completion+=("--serviceCreateBody.UpdateConfig.Order")
    flags_completion+=("__dockerctl_handle_go_custom_completion")
...
_dockerctl_service_ServiceUpdate()
{
    ...
    flags_with_completion+=("--serviceUpdateBody.RollbackConfig.FailureAction")
    flags_completion+=("__dockerctl_handle_go_custom_completion")
    ...
    flags_with_completion+=("--serviceUpdateBody.RollbackConfig.Order")
    flags_completion+=("__dockerctl_handle_go_custom_completion")
    ...
    flags_with_completion+=("--serviceUpdateBody.TaskTemplate.ContainerSpec.Isolation")
    flags_completion+=("__dockerctl_handle_go_custom_completion")
    ...
    flags_with_completion+=("--serviceUpdateBody.TaskTemplate.RestartPolicy.Condition")
    flags_completion+=("__dockerctl_handle_go_custom_completion")
    ...
    flags_with_completion+=("--serviceUpdateBody.UpdateConfig.Order")
    flags_completion+=("__dockerctl_handle_go_custom_completion")
